...
public class DList extends List {
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
      DListNode newFront = newNode(item,this,null,null);
      newFront.next = this.head.next;
      newFront.prev = this.head;
      this.head.next.prev = newFront;
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
      DListNode newBack = newNode(item,this,null,null);
      newBack.prev = this.head.prev;
      newBack.next = this.head;
      this.head.prev.next = newBack;
